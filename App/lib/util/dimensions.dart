class Dimensions {
  static const double iconSizeVerySmall = 8.0;
  ...
  static const double paddingSizeCard = 1.0;
  ...
  static const double paddingSizeCustomBottom = 56.0;
  static const double homePagePadding = 15.0;
  static const double paddingSizeExtraExtraLarge = 30.0;
  ...
  static const double revenueCard = 150.0;
  static const double dashboardCardWidth = 180.0;
  static const double dropDownWidth = 110.0;
  ...
  static const double PADDING_SIZE_CARD = 1.0;
  static const double PADDING_SIZE_BORDER = 3.0;
  static const double PADDING_SIZE_MEDIUM_BORDER = 5.0;
  ...
  static const double PADDING_SIZE_REVENUE_BOTTOM = 45.0;
  static const double PADDING_SIZE_CUSTOMER_BOTTOM = 56.0;
  static const double HOME_PAGE_PADDING = 15.0;
  static const double PADDING_SIZE_EXTRA_EXTRA_LARGE = 30.0;
}
