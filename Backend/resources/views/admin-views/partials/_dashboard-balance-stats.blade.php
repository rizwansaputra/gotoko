            ...
            <div class="flex-between align-items-center mb-1">
                <div>
                    ...
                    <span class="card-title h2 text-white">
                        {{ \App\CPU\Helpers::rupiah($account['total_income']-$account['total_expense']) }}
                    </span>
                </div>
                <div class="mt-2">
    ...
    <div class="card-body">
        <div class="flex-between align-items-center mb-1">
            <div>
                ...
                <span class="card-title h2 text-white">
                    {{ \App\CPU\Helpers::rupiah($account['total_income']) }}
                </span>
            </div>
            <div class="mt-2">
                <i class="tio-money-vs text-white font-one"></i>
    ...
    <div class="card-body">
        <div class="flex-between align-items-center mb-1">
            <div>
                ...
                <span class="card-title h2 text-white">
                    {{ \App\CPU\Helpers::rupiah($account['total_expense']) }}
                </span>
            </div>
            <div class="mt-2">
    ...
    <div class="card-body">
        <div class="flex-between align-items-center mb-1">
            <div>
                ...
                <span class="card-title h2 text-white">
                    {{ \App\CPU\Helpers::rupiah($account['total_payable']) }}
                </span>
            </div>
            <div class="mt-2">
                <i class="tio-money-vs text-white font-one"></i>
    ...
    <div class="card-body">
        <div class="flex-between align-items-center mb-1">
            <div>
                ...
                <span class="card-title h2 text-white">
                    {{ \App\CPU\Helpers::rupiah($account['total_receivable']) }}
                </span>
            </div>
            <div class="mt-2">
                <i class="tio-money-vs text-white font-one"></i>
