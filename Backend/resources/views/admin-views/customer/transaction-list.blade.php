                        ...
                        <table
                            ...
                            @foreach($transactions as $key=>$transaction)
                                <tr>
                                    ...
                                    <td>{{ \App\CPU\Helpers::rupiah($transaction->amount) }}</td>

                                    <td>{{ $transaction->date }}</td>
                                    <td>
                                        @if ($transaction->debit)
                                                {{ \App\CPU\Helpers::rupiah($transaction->amount) }}
                                        @else
                    ...
                    @if($customer)
                        <div class="card-body">
                            ...
                            <div class="media align-items-center mt-1" href="javascript:">
                                ...
                                <div class="media-body">
                                    <span
                                        class="text-body text-hover-primary">{{\App\CPU\Helpers::rupiah($customer->balance)}}</span>
                                </div>
                            </div>
