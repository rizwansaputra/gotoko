                        ...
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            @foreach($products as $key=>$product)
                                <tr>
                                    ...
                                    <td>
                                        @if($product->supplier)
                                            <a style="color:  #677788;" href="{{route('admin.supplier.view',[$product->supplier_id])}}">{{ $product->supplier->name }}</a><br>
                                            <a style="color:  #677788;" href="tel:{{$product->supplier->mobile}}">{{$product->supplier->mobile}}</a>
                                        @else
                                    ...
                                    <td>{{\App\CPU\Helpers::rupiah($product['purchase_price']) }}</td>
                                    <td>{{\App\CPU\Helpers::rupiah($product['selling_price']) }}</td>
                                    <td>
                                        {{ $product['quantity'] }}
