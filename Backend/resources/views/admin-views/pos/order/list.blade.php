                ...
                >
                    ...
                    @foreach($orders as $key=>$order)
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td>
                                {{ \App\CPU\Helpers::rupiah($order->order_amount) }}
                            </td>
                            <td>{{\App\CPU\Helpers::rupiah($order['total_tax'])}}</td>
                            <td>{{\App\CPU\Helpers::rupiah($order->extra_discount?$order->extra_discount:0)}}</td>
                            <td>{{\App\CPU\Helpers::rupiah($order->coupon_discount_amount?$order->coupon_discount_amount:0)}}</td>
                            <td>{{\App\CPU\Helpers::rupiah($order->order_amount + $order->total_tax - $order->extra_discount - $order->coupon_discount_amount)}}</td>
                            <td>
