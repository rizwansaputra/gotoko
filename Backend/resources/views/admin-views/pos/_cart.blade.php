                        ...
                        @foreach (session($cart_id) as $key => $cartItem)
                            @if (is_array($cartItem))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            {{ \App\CPU\Helpers::rupiah($product_subtotal) }}
                                        </div>
                                    </td>
                                    <td>
...
<div class="box p-3">
    <dl class="row">
        ...
        <dd class="col-6 text-right">{{ \App\CPU\Helpers::rupiah($subtotal) }}</dd>


        <dt class="col-6">{{ \App\CPU\translate('product_discount') }} :</dt>
        <dd class="col-6 text-right">{{ \App\CPU\Helpers::rupiah($discount_on_product) }}
        </dd>
        ...
        <dd class="col-6 text-right">
            <button id="extra_discount" class="btn btn-sm" type="button" data-toggle="modal"
                data-target="#add-discount"><i
                    class="tio-edit"></i></button>{{ \App\CPU\Helpers::rupiah($discount_amount) }}
        </dd>
        ...
        <dd class="col-6 text-right">
            <button id="coupon_discount" class="btn btn-sm" type="button" data-toggle="modal"
                data-target="#add-coupon-discount"><i
                    class="tio-edit"></i></button>{{ \App\CPU\Helpers::rupiah($coupon_discount) }}
        </dd>

        <dt class="col-6">{{ \App\CPU\translate('tax') }} :</dt>
        <dd class="col-6 text-right">{{ \App\CPU\Helpers::rupiah(round($total_tax_amount, 0)) }}</dd>
        ...
        <dd class="col-6 text-right h4 b">
            <span id='total_price' style="display:none">{{ round($total + $total_tax_amount - $coupon_discount, 0) }}</span>
            <span id="total_harga">{{ \App\CPU\Helpers::rupiah($total + $total_tax_amount - $coupon_discount) }}</span>
        </dd>
    </dl>
    <div class="row g-2">
